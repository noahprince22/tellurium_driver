module TelluriumDriver
  class Driver
    ...
    #    TelluriumDriver::Driver.new(browser: "chrome")
    #
    ...
    TelluriumDriver::Driver.before(TelluriumDriver::Driver.instance_methods.reject { |name| name.to_s.include?("initialize")}) do
      begin
        if(self.class.wait_for_document_ready)
